...
import static com.skillogs.yuza.config.SecurityConstants.*;
...
public class TokenAuthenticationService {
    ...
    @Autowired
    public TokenAuthenticationService(@Value("${key.rsa.private}") String keyPriv,
    ...
    private String getUsernameFromToken(String token) {
        try {
            ...
            System.out.println("Can't get email from token");
            return null;
        }
    }
